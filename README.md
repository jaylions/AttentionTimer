...
하얗고 복슬복슬한 강아지. 상태에 따라 표정·귀·앞발이 바뀐다.
**전부 코드로 그린다** — 이미지 파일 한 장 없이 `NSBezierPath` 로만.
털 실루엣은 원의 반지름을 각도에 따라 흔들어서 만든다 (`fluff()`).

| 상태 | 강아지 | 말풍선 |
|---|---|---|
| 대기 | 눈 감고 꾸벅꾸벅, 귀 축 늘어짐, `z` | "오늘도 해볼까?" |
| 집중 중 | 눈 뜨고 앞발을 번갈아 움직임 (타자 치는 동작) | "잘하고 있어" / "절반 왔다" / "5분 남았어" |
| **딴짓 감지** | **눈썹 치켜뜨고 귀 쫑긋, 입 헤벌린 채 부들부들, 💢** | **"야." "어디 가" "지금 뭐 하는데" …** |
| 완료 | 눈이 `^ ^`, 앞발 번쩍 들고 폴짝폴짝 | "한 번도 안 흔들렸어!" |
